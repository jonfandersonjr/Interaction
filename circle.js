...
Circle.prototype.update = function () {
    ...
    switch (this.colorNum) {
        case 0:
            break;
        case 1:
            if (Math.floor((Math.random() * ((50000 - 0)))) < 1) {
                this.colorNum = 2;
            } else {
                this.growthTime -= this.gameEngine.clockTick;
        ...
        case 2:
            ...
            break;
        case 3:
            this.ashDuration -= this.gameEngine.clockTick;
